...
function formUni(){
    ...
    nombreUniversidad.className="form-control"
    ...
    carreraNombre.className="form-control"
    ...
    inicioFecha.className="form-control"
    ...
    finalizacionFecha.className="form-control"
